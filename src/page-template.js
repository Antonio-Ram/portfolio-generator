...
const generateAbout = aboutText => {
  ...
  <section class="my-3" id="about">
    <h2 class="text-dak bg-primary p-2 display-inline-block">About Me</h2>
    <p>${aboutText}</p>
  `;
};
...
// Pulled from app.js to remove clutter. Using modularzation to call function back into app.js (Export, require)
